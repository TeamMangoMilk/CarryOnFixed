...
package mangomilk.carryon.config;
...
import mangomilk.carryon.config.annotations.Category;
import mangomilk.carryon.config.annotations.Config;
import mangomilk.carryon.config.annotations.Property;
